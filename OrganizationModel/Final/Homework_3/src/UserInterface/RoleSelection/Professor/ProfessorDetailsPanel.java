...
public class ProfessorDetailsPanel extends javax.swing.JPanel {
   ...
   DegreeList degreeList; 
    ...
    public ProfessorDetailsPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,  StudentList studentList, StudentLoginList studentLoginList, ThirdPartyList thirdPartyList, HashMap<String, List<Course>> studentCour, DegreeList degreeList ) {
        initComponents();
    ...
    public boolean searchCourseID(String searchCID) {
     ...
     public HashMap<String, List<Course>> getStudentCourses() {
        return studentCour;
    }

    public void setStudentCourses(HashMap<String, List<Course>> studentCour) {
        this.studentCour = studentCour;
    }
    ...
    private void initComponents() {
        ...
        lblProfDetailsTitle.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblProfDetailsTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        btnProfAddCourse.setBackground(new java.awt.Color(204, 204, 255));
        ...
        btnProfUpdateCourse.setBackground(new java.awt.Color(204, 204, 255));
        ...
        btnProfDelCourse.setBackground(new java.awt.Color(204, 204, 255));
        ...
        btnStudentList.setBackground(new java.awt.Color(204, 204, 255));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblProfDetailsTitle, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void btnStudentListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStudentListActionPerformed
        ...
        ProfessorStudentListPanel studentPanel = new ProfessorStudentListPanel(userProcessContainer,professorList, professorLoginList,courseList,studentList,studentLoginList, thirdPartyList, studentCour);
        DefaultTableModel studentModel =  studentPanel.getEnrolledStu();
        studentModel.setRowCount(0);
    if (studentCour.isEmpty()) {
        JOptionPane.showMessageDialog(this, "No students are registered in the course.");
    } else {   
        for (Map.Entry<String, List<Course>> entry : studentCour.entrySet()) {
            String studentName = entry.getKey();
            List<Course> coursesT = entry.getValue();
        
            for (Course course : coursesT) {
                if (course.getProfCName().equals(txtProfName.getText())) {
                Object addC[] = new Object[2];
                
                addC[0] = studentName;
                addC[1] = course.getCourseName();
            
                studentModel.addRow(addC);
            }
        }
       }
