...
public class StudentLoginPanel extends javax.swing.JPanel {
    ...
    public StudentLoginPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,  StudentList studentList, StudentLoginList studentLoginList, ThirdPartyList thirdPartyList, DegreeList degreeList) {
        initComponents();
    ...
    private void btnStudentLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStudentLoginActionPerformed
        ...
        StudentCatalogPanel studCatalog = new StudentCatalogPanel(userProcessContainer, professorList, professorLoginList, courseList, studentList, studentLoginList, thirdPartyList, degreeList);
        ...
        for(int i=0;i < studModel.getRowCount(); i++){
            ...
            if(enteredUsername.equals(username) && enteredPassword.equals(password)){
              StudentDetailsPanel detailsPanel = new StudentDetailsPanel(userProcessContainer, professorList, professorLoginList, courseList, studentList, studentLoginList, thirdPartyList, degreeList);
