...
/**
    ...
    public ProfessorLoginPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,  StudentList studentList, StudentLoginList studentLoginList,ThirdPartyList thirdPartyList ) {
        initComponents();
    ...
    private void btnProfLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfLoginActionPerformed
        ...
        int rowCount = 0;
        ProfessorCatalogPanel profCatalog = new ProfessorCatalogPanel(userProcessContainer, professorList, professorLoginList, courseList, studentList,studentLoginList, thirdPartyList, degreeList);
        ...
        for(int i =0; i < profModel.getRowCount(); i++){
            ...
            if(enteredUsername.equals(username) && (enteredPassword.equals(password))){
                ProfessorDetailsPanel detailsPanel = new ProfessorDetailsPanel(userProcessContainer,professorList, professorLoginList, courseList, studentList, studentLoginList, thirdPartyList, degreeList);
